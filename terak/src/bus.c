...
uint8_t bus_read_byte(paddr_t addr) {
    ...
    switch (addr) {
        ...
        case 0177400: case 0177402: case 0177404: case 0177406:
        case 0177410: case 0177412: case 0177416:
...
void bus_write_word(paddr_t addr, uint16_t val) {
    bus_write_byte(addr, (uint8_t)(val & 0xFF));
    bus_write_byte((paddr_t)(addr + 1), (uint8_t)((val >> 8) & 0xFF));
}
